...
SECTOR_MAP = {
    ...
    "power-ic": "功率半導體元件",
    "power-epi": "功率半導體基板",
    "power-assembly": "功率半導體封測/導線架",
    "power-module": "功率模組/散熱/電源",
    "ai-server": "AI伺服器",
    "pcb": "PCB",
...
STOCK_SECTOR = {
    ...
    # === 功率半導體元件 (PMIC + MOSFET + 二極體) ===
    "6415": "power-ic",    # 矽力*-KY (PMIC)
    "6719": "power-ic",    # 力智 (PMIC)
    "8081": "power-ic",    # 致新 (PMIC)
    "6138": "power-ic",    # 茂達 (PMIC)
    "8261": "power-ic",    # 富鼎 (MOSFET)
    "6435": "power-ic",    # 大中 (MOSFET)
    "5299": "power-ic",    # 杰力 (MOSFET)
    "3317": "power-ic",    # 尼克森 (MOSFET)
    "2342": "power-ic",    # 茂矽 (MOSFET)
    "8255": "power-ic",    # 朋程 (二極體)
    "2481": "power-ic",    # 強茂 (二極體)
    ...
    "3016": "power-epi",   # 嘉晶 (基板)
    "6182": "power-epi",   # 合晶 (基板)
    "2455": "power-epi",   # 全新 (基板)
    "3707": "power-epi",   # 漢磊 (第三代晶圓代工)
    "3105": "power-epi",   # 穩懋 (GaAs/Ga)

    # === 功率半導體封測/導線架 ===
    "2351": "power-assembly",  # 順德 (導線架)
    "5285": "power-assembly",  # 界霖 (導線架)
    "6525": "power-assembly",  # 捷敏-KY (封測)

    # === 功率模組/散熱/電源 ===
    "2241": "power-module",    # 艾姆勒 (散熱模組)
    "2308": "power-module",    # 台達電 (電源供應器)
