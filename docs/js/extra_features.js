...
(function() {
    ...
    const SECTOR_MAP = {
        // 最細分類放前面 (優先匹配)
        'IC設計': ['2454','2357','2337','3006','3443','4919','4961','4966','4967','6510','6415','6257','3665','6669','8086'],
        '晶圓代工': ['2330','2303','5347','6770','6805'],
        '封測': ['3016','6239','3008','3045','6515'],
        '記憶體': ['2408'],
        'AI伺服器/電子組裝': ['2317','2324','2356','2376','2382','3231','3661','2404'],
        ...
        '光電面板': ['2409','3481'],
        '通信網路': ['2345','5274','5328','6284','8096','8289'],
        ...
        '電子零組件': ['1590','2352','2428','2439','2449','2481','3017','3217','3264','3356','3357','3376','3450','3498','3535','3537','3624','3680','5291','5425','5439','6104','6127','6147','6187','6191','6223','6261','6271','6284','6462','6485','6727','8040','8091','8150','8210','8358','8996'],
    };
